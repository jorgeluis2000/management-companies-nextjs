...
export default function SheetAddUser({ description, title }: IProps) {
  ...
  const [addUser, { data: userAdded, error: errorAdded }] = useMutation<TAddUser, AddUserParams>(
    ADD_USER,
  );
  ...
  return (
    <Sheet>
      ...
      >
        ...
        <form
          className="grid grid-cols-1 md:grid-cols-2 gap-4 gap-y-8 py-4"
          onSubmit={eventHandlerAdd}
        >
          ...
          <div className="space-y-2">
            ...
            <Select name="theme" defaultValue="AUTO">
              <SelectTrigger id="theme-transaction-add" className="col-span-3">
                <SelectValue
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              type="password"
              placeholder={t("sheetAddUser.inputs.placeholderPasswordConfirm")}
              className="col-span-3"
            />
          </div>
          <SheetFooter>
            <SheetClose asChild>
              <Button type="submit">{t("sheetAddUser.btnSaveName")}</Button>
            </SheetClose>
          </SheetFooter>
        </form>
      </SheetContent>
